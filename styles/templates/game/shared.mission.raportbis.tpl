...
<script type="text/javascript">
    ...
    <div style="float:left; width:378px;" class="batle_party">
        <table>
            <tr>
                <td style="text-align:right; padding-right:7px; height:67px">{$Info.0}</td>
    ...
    <div style="float:right" class="batle_party">
        <table>
            <tr>                            	
                ...
                <td style="text-align:left; height:67px">{$Info.1}</td>
            </tr>
        </table>
    </div>                    
    <div id="batle_vs">
...
<script type="text/javascript">
    ...
    var disqus_shortname = 'darkspaceempire';
