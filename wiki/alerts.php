...
<div>  
 <p>
Now we will focus on warning signals. In this project, there is one types of signals: the graphics signals. Graphic work when a player scan or attack your planets, or when a players try to destroy your moons or if he send you missiles <p />


Graphic signals are displayed above the server time in the left menu. Here you can see how it looks.
<div align="center"><img style="border-radius:10px"   src="html/images/20/1.png" > </div><p> 
