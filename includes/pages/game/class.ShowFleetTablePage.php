...
class ShowFleetTablePage extends AbstractPage
{
	...
	if ($targetMission != 12){	
		...
		$this->tplObj->assign_vars(array(
			...
			'FleetsOnPlanetProccesors'		=> $FleetsOnPlanetProccesors,
			...
			'bonusAttack'			=> $USER[$resource[109]] + getbonusOne(1102,$USER['academy_1102']) + getbonusOne(1101,$USER['academy_1101']) + (abs($USER['factor']['Attack'])) * 100,
			'bonusDefensive'		=> $USER[$resource[110]] + (abs($USER['factor']['Defensive'])) * 100,
			'bonusShield'			=> $USER[$resource[111]] + (abs($USER['factor']['Shield'])) * 100,
