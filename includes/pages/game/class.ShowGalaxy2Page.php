...
class ShowGalaxy2Page extends AbstractPage
{
	...
	public function show()
	{
		...
		$this->tplObj->loadscript("three.min.js");
        ...
        $this->tplObj->assign_vars(array(
			'man_p'				=> $USER['id_planet'],
			'GalaxyRows'				=> $Result,
			'tut_info'				=> $tut_info,
			'db_link'				=> $db_link,
			'planetcount'				=> $LNG['gl_populed_planets'],
			'planetcount1'				=> count($Result),
			'action'					=> $action,
			'galaxy'					=> $galaxy,
			'system'					=> $system,
			'planet'					=> $planet,
			...
			'immunity'					=> $LNG['gl_short_immunity'],
