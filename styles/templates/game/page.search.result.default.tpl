...
<table style="width:760px" id="resulttable">
	...
	<tr>
		...
		{if $searchRow.planet_cloak > $searchRow.TIMER}
		<td>[*:***:**] </td>
		{else}
		<td><a href="game.php?page=galaxy&amp;galaxy={$searchRow.galaxy}&amp;system={$searchRow.system}">[{$searchRow.galaxy}:{$searchRow.system}:{$searchRow.planet}]</a> </td>{/if}
