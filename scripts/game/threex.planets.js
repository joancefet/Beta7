...
THREEx.Planets.baseURL	= 'scripts/game/'
...
THREEx.Planets.createEarth	= function(){
	var geometry	= new THREE.SphereGeometry(0.5, 32, 32)
	var material	= new THREE.MeshPhongMaterial({
		map		: THREE.TextureLoader(THREEx.Planets.baseURL+'images/earthmap1k.jpg'),
		bumpMap		: THREE.TextureLoader(THREEx.Planets.baseURL+'images/earthbump1k.jpg'),
		bumpScale	: 0.05,
		specularMap	: THREE.TextureLoader(THREEx.Planets.baseURL+'images/earthspec1k.jpg'),
