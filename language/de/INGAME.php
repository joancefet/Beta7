 ...
 * @link http://2moons.cc/
 */
$LNG['AllianceInfoTrans1']=						'Es ist wichtig:';
$LNG['harvo1']			=						'Du hast';
$LNG['ha99']=						'Beschreibung';
$LNG['harvo2']			=						' übrig.';

$LNG['ha1']				=					'Jedes ernten kostet 1 H-Punkt. Was macht das Ernten? Es sammelt  (metal / crystal / deuterium) von all deinen ausgewählten Planeten auf dein jetzigen Planet';
$LNG['ha2']				=					'
Es wird empfohlen keine Deut Plants für die Produktion von Energy zu benutzen. Die beste Option ist das Solar Kraftwerk, die Solar Sateliten oder Offiziere. Falls du Deut Plants doch benutzt, musst du nach dem Ernten mehrere Male alle Planeten aktuallisieren bis du genug Deuterium für die Energy Produktion haben wirst. ';
$LNG['ha3']				=					'Wähle die Anzahl von Harvest Punten aus, die du kaufen möchtest';
$LNG['ha4']				=					'Kaufe Harvest Punkte';
$LNG['nia']			=              'Keine einkommenden Angriffe';
$LNG['yednc']			=              'Dein Imperium wird nicht mehrfach angegriffen';
$LNG['ymss']			=              'Dein Mond ist sicher';
$LNG['yeinbs']			=              'Dein Imperium wird nicht beobachtet';
$LNG['nir']			=              'Keine einkommenden Raketen';
$LNG['ind1']		=							'Um zu spielen brauchst du nur einen Web Browser.';
$LNG['ind2']		=							'Soziales Netzwerk';
$LNG['ind3']		=							'Gefällt mir und folgen!';
$LNG['ind4']		=							'Neu diesen Monat:';
$LNG['ind5']		=							'Neue HoF:';
$LNG['ind6']		=							'Gehe zum Forum ...';
$LNG['ind7']		=							'Mehr...';
$LNG['ind8']		=							'Zeige alle Nachrichten';
$LNG['ind9']		=							'Wir empfehlen: ';
$LNG['ind10']		=							'Trete uns bei!!';
$LNG['NewPlay']								= 'Neuster Spieler:';
$LNG['welto']		=							'Willkommen zur wundervollen Welt von Zyperax';	
$LNG['LotteryWinning']									= 'Lotterie Gewinn:';
$LNG['FLMaster']							= 'Flottenmeister:';
$LNG['NumerPremium']						= 'Anzahl der Spieler mit Premium:';
$LNG['NumberCoPlanets']						= 'Kolonisierte Planeten:';
$LNG['PlaAmount']							= 'Spieleranzahl:';
$LNG['user_Message_none']					=  'Keine Benutzer Nachricht.';
$LNG['WriteAMess']							= 'Klicke hier, um eine Nachricht zu schreiben';
 $LNG['in1']		=							'Spielen';
$LNG['in2']		=							'Registeration';
$LNG['CostOf1']	=							'Kosten eines Tickets';
$LNG['Lo1']		=							'Anti Materie Lotterie';
$LNG['Lo2']		=							' Nächste Ziehung in: ';
$LNG['IB']								= 'Sofort beenden';

$LNG['fm1']			=							'Du bist Fleet Master!<br>
					Du bist befugt die Fleet Geschwindigkeit vom Universum zu ändern für je 5000 Dark Materie<br>
					Du kannst es so oft benutzten wie du kannst.<br>
					<br>Versuche rauszufinden wie es nutzvoll sein kann für deine Raids, Angriffe und Verteidigungen
					<br><br>
					Die neue Geschwindigkeit muss zwischen ';
					$LNG['fm2']				=					' und ';
					$LNG['fm3']				=					'Kosten::';
					$LNG['fm4']				=					'Momentane Fleet Geschwindigkeit';
$LNG['Lo3']		=							'Preis : 
			<br>
			<font color="lime">Der Gewinner bekommt </font>';
			
			$LNG['Lo99'] = ' <font color="lime">Anti Materie x der Anzahl seiner tickets <br>
			Mindestens {$minimum_users} Spieler müssen mit machen, falls der Timer ausläuft und die Minimum anzahl von {$minimum_users} nicht erreicht ist ist wird die Lotterie zurückgesetzt und um 250 Anti Materie erhöht.';
			$LNG['NoWinners'] =						'"<p>Momentan gibt es keine Gewinner im System</p>"';
			$LNG['Lo4']		=							'Wie viele Tickets willst du kaufen ?';
$LNG['Lo5']		=							'Ein Spieler hat maximal ';

$LNG['boti']	=							'Du hast die Anzahl an Tickets gekauft  ';
$LNG['MaxmimumAB']	=							'Du hast schon deine maxmimale Anzahl an Tickets gekauft.';
$LNG['NotEnRes']	=							'Du hast nicht genug Resourcen um dir die Anzahl der Tickets zu gekauft.';

$LNG['Mic1']	=							'Schreibe hier einen Kommentar, dieser wird in den Caliban Live News gezeigt, solange bis jemand anderes etwas schreiben moechte. (Maximal 100 Zeichen.)';
$LNG['Mic2']	=							'
	  Hier kannst du eine persoenliche Nachricht in unseren News anzeigen lassen (Max 100 Symbole), diese Nachricht findest du in der Uebersicht. 
	In deiner Nachricht sollte es z.B. um folgende Themen gehen.<br>
	- Rekutierung<br>
	- Anfragen<br>
	- Etwas interesantes fuer alle Spieler.<br>
	
	Bei anstoessigen Nachrichten wird die Nachricht sofort geloescht und der Spieler erhaelt vorerst eine Verwahnung.
	
    Die Nachricht sollte so gut wie moeglich keine Rechtschreibfehler erhalten und ausschliesslich Deutsch sein.';
$LNG['in3']		=							'Regeln';
$LNG['in4']		=							'Nachrichten';
$LNG['in5']		=							'Über uns';
$LNG['in6']		=							'Account';
$LNG['in7']		=							'Erstelle ein Account';
$LNG['in8']		=							'Passwort zurücksetzen ';

$LNG['in10']		=							'Community';
$LNG['in11']		=							'Forum';
$LNG['in12']		=							'Gallerie';
$LNG['in13']		=							'2014 &copy; Jeremy & Zyperaxgalaxy &middot;Alle Rechte vorbehalten ';
 
$LNG['rest1']		=							'Logge dich in deinen Account ein';
$LNG['rest2']		=							'Erinnere dich';
$LNG['rest3']		=						'Log mich ein';
$LNG['rest4']	=							'Wir garantieren die Geheimhaltung eurer Daten.';
$LNG['rest5']		=							'Erstelle ein Account';
$LNG['rest6']		=							' Unter diesem Namen bist du im Spiel bekannt, benutz Buchstaben und Zahlen';
$LNG['rest7']		=							'Muss gültig sein <br>Voraussetzung beim Anmelden. ';
$LNG['vote1']		=							'Wähle für den Wachstum des Servers und für die Verbesserungen!';
$LNG['rest8']		=							'Mit dem klicken auf "play" akzeptierst du die  ';
$LNG['rest9']		=							' Regeln';

$LNG['Messages']							= 'Nachrichten';
$LNG['write_message']						= 'Schreibe eine Nachricht';
$LNG['OResearch']						= 'Forschung';
$LNG['OBuildings']						= 'Geb&auml;ude';
$LNG['OFleet']						= 'Flotte';
$LNG['ORef']								= 'Lade deine Freunde ein und bekomme 5,000,000 Dunkle Materie und 10.000 Anti Materie';
$LNG['PM']									= '[PN]';
$LNG['ready']								= 'Fertig';
...
$LNG['type_mission'][16] 					= 'Hostile Expedition';
$LNG['type_mission'][17] 					= 'Barbarians Expedition';
$LNG['type_mission'][18] 					= 'Pirates Expedition';
$LNG['type_mission'][19] 					= 'Strangers Expedition';
$LNG['type_mission'][12] 					= 'Asteroid';

$LNG['type_planet'][1]  					= 'Planet';
$LNG['type_planet'][2]  					= 'Trümmerfeld';
$LNG['type_planet'][3]  					= 'Mond';
$LNG['type_planet'][4]  					= 'Festung';
...
$LNG['mg_delete_type_all']					= 'Alle nachrichten dieses Kategorie löschen';
...
$LNG['al_rank_desc']['BANK']			= 'Erlauben, die Allianz Bank verwenden';
$LNG['al_rank_desc']['PLANETS']			= 'Verwendung Planeten Allianz';
