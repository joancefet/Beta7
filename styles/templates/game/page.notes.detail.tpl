        ...
        <table class="ally_ranks gray_stripe_th td_border_bottom">
            <tbody><tr>
                ...
                <td>
                    ...
                    <input id="title" placeholder="title" name="title" size="30" maxlength="30" value="{$noteDetail.title}" type="text">
                </td>
            </tr>
            <tr>
                <td colspan="2">
                    <textarea name="text" placeholder="text" id="text" cols="60" rows="10" onkeyup="$('#cntChars').text($(this).val().length);">{$noteDetail.text}</textarea>
                </td>
            </tr>
            <tr>
                <td colspan="2" style="text-align:center;">
                    ...
                    <a style="float:right;" href="game.php?page=notes">back</a>
                </td>
            </tr>
        </tbody></table>
    </form>
