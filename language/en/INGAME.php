...
$LNG['ha99']=						'Harvest Description';
$LNG['ha1']				=					'Every Harvest costs 1 HP(harvest point). What does harvest do? : it will get all the resources (metal / crystal / deuterium) from the selected planets and from the planet where you find yourself on.';
$LNG['ha2']				=					'
...
$LNG['ha3']				=					'Select the number of harvest points that you want to buy ';
$LNG['ha4']				=					'Buy Harvest points';
$LNG['harvo1']			=						'You have';
$LNG['harvo2']			=						' left.';
$LNG['Messages']							= 'Messages';
$LNG['ORef']								= 'Invite your friends and get: 5,000,000 Dark Matter and antimatter 10,000.';
$LNG['PM']									= '[PM]';
$LNG['OResearch']						= 'Research';
$LNG['OBuildings']						= 'Buildings';
$LNG['OFleet']						= 'Fleet';
$LNG['AllianceInfoTrans1']=						'it\'s important:';
$LNG['write_message']						= 'Write message';
$LNG['nia']			=              'No incomming attacks';
$LNG['yednc']			=              'Your Empire do not capture';
$LNG['ymss']			=              'Your Moon is secure';
$LNG['yeinbs']			=              'Your empire is not being spyed';
$LNG['ready']								= 'Ready';

$LNG['Lo1']		=							'Anti Matter Lottery ';
$LNG['Lo2']		=							' Lottery Next lottery drawing in ';


$LNG['fm1']			=							'You are now the Fleet Master!<br>
					You are allowed to change the universes fleet speed by paying 5.000 Dark matter each time you want to change.<br>
					You can use this privilage unlimited times.<br>
					<br>Try to find out how it can be useful for your raids and concuring the universe.
					<br><br>
					The new fleet speed must be between ';
					$LNG['fm2']				=					' and ';
					$LNG['fm3']				=					'Fleet costs:';
					$LNG['fm4']				=					'Current Flight Speed';
					
					
$LNG['Lo3']		=							'Prize : 
			<br>
			<font color="lime">The winner will get </font>';
			$LNG['Lo99'] =
			'<font color="lime"> units of Anti Matter x number of tickets bought <br> At leatest it\'s required 10, if the time expires and the system doesn\'t have minimum of 10 then the system will reset the timer back to 12h and the prize will increase with 250 AM every post-ponning.';
$LNG['Lo4']		=							'How many tickets you want to buy ?';
$LNG['Lo5']		=							'One player can buy maximum ';
$LNG['NewPlay']								= 'Newest Player';
	$LNG['NoWinners'] =						'"<p>For now there are no winners in the lottery system </p>"';
$LNG['LotteryWinning']									= 'Lottery winning Amount:';
$LNG['FLMaster']									= 'Fleetmaster:';
$LNG['NumerPremium']									= 'Number of Players with Premium:';
$LNG['NumberCoPlanets']									= 'Colonised Planets:';
$LNG['PlaAmount']									= 'Player Amount:';


$LNG['boti']	=							'You have bought the Tickets ';
$LNG['MaxmimumAB']	=							'You have already bought the maximum ticket number.';
$LNG['NotEnRes']	=							'You do not have enough ressources to buy the tickets.';
$LNG['IB']								= 'Instant Finish';

$LNG['loading']								= 'Loading ...';

$LNG['Mic1']	=							'Write here a Message, it´ll be shown until someone else wants to write a Message to all players. Message is shown in our News on Overview. (Maxmimum: 100 Characters.)';
$LNG['CostOf1']	=							'Cost for 1 Ticket';
$LNG['Mic2']	=							'
	 . 
	Themes your Comment should be go around.<br>
	- Recruiting<br>
	- Requests<br>
	- Something interesting for all players.<br>
	
	At Messages which are violent,harassment,Advertisment or something else, the Message will be deleted and Player will be warned!
	
    Your Message should be without grammar problems and only in German and English!';
$LNG['invalid_action']						= 'Action Invalidated!!';
$LNG['user_Message_none']							= 'No Player´s Message.';
$LNG['WriteAMess']							= 'Click here, to write a Message';
...
$LNG['type_mission'][20] 					= 'Capture';

$LNG['rest1']		=							'Login to your personal account';
$LNG['rest2']		=							'Remember me';
$LNG['rest3']		=							'Sign in';
$LNG['rest4']	=							' We guarantee the confidentiality of the data you entered.';
$LNG['rest5']		=							'Create an account';
$LNG['rest6']		=							' Under this name, you will know the other players. Use letters and numbers.';
$LNG['rest7']		=							'Must be valid. <br>Required when entering. ';
$LNG['rest8']		=							'Clicking on Play, you agree to ';
$LNG['rest9']		=							' Rules';
...
$LNG['fl_hostile_alert_message']		    = 'Hostile Expeditions are dangerous missions, you can lose your fleet!';
$LNG['fl_dm_alert_message']                 = 'Beware, if in %s, %s was found, the fleets will be irrevocaly destroyed!';
...
$LNG['bd_cancel_warning']                   = 'When you remove from the queue will be returned only 60% of the resources.';
...
$LNG['sys_notenough_money'] 				= 'You dont have enough resources avaible on %s <a href="./game.php?page=buildings&amp;cp=%d&amp;re=0">[%d:%d:%d]</a> for building what you wanted to do. <br>Your ressources is %s %s , %s %s and %s %s. <br>The cost of construction  is %s %s , %s %s and %s %s.';
...
$LNG['al_make_ally_insufficient_points ']					= 'You need minimum %s (%s) points to form an alliance';
...
$LNG['ind1']		=							'To play, you will need only a web-browser.';
$LNG['ind2']		=							'Social Networks';
$LNG['ind3']		=							'Subscribe and like.';
$LNG['ind4']		=							'New this month:';
$LNG['ind5']		=							'New HOF:';
$LNG['ind6']		=							'Go to the forum ...';
$LNG['ind7']		=							'More...';
$LNG['ind8']		=							'Show all news';
$LNG['ind9']		=							'we recommend: ';
$LNG['ind10']		=							'Join us!';
$LNG['in1']		=							'Play';
$LNG['in2']		=							'Register';
$LNG['in3']		=							'Rules';
...
$LNG['in5']		=							'About us';
$LNG['in6']		=							'Account';
$LNG['in7']		=							'Create an Account';
$LNG['in8']		=							'Recover Password';
$LNG['in10']		=							'Community';
$LNG['in11']		=							'Forum';
$LNG['in12']		=							'Gallery';
$LNG['in13']		=							'2014 &copy; Jeremy & Zyperaxgalaxy &middot;All rights reserved ';
...
$LNG['al_rank_desc']['BANK']			= 'Allow to use the alliance bank';
$LNG['al_rank_desc']['PLANETS']			= 'Use planets alliance';
...
//OPTIONS
$LNG['op_error']							= 'Error';
$LNG['op_cant_activate_vacation_mode']		= 'You can not activate the vacation mode with fleet activities.';
...
$LNG['sys_refferal_text']        	 		= 'The player %s recruited by you reached %s points.<br>Thanks for inviting an active player, you received as bonus %s %s and %s %s';
...
$LNG['ebo_notadmin'] = 'You don\'t have access to Ticket #%d!'; 
...
$LNG['lo_logout']							= 'Your session was terminated. See you soon';
$LNG['lo_redirect']							= 'Redirect';
$LNG['lo_notify']							= 'You will be redirected in <span id="seconds">5</span> seconds';
$LNG['lo_continue']							= 'Click here if you don\'t want to wait';

//----------------------------------------------------------------------------//

//----------------------------------------------------------------------------//
// Donate
$LNG['don1']							    = 'Donate (Keep this server alive)';
$LNG['don2']							    = 'Assistance in obtaining dark matter can be obtained from the Administrator';
$LNG['don3']							    = 'Technical support - [Links]';
$LNG['don5']							    = 'You have in total';
$LNG['don6']							    = 'Loyality Points';
$LNG['don7']							    = 'this offer you';
$LNG['don8']							    = 'dark matter extra on each purchase';
$LNG['don9']							    = 'Buying rate Credit (Paypal)';
$LNG['don10']							    = 'Number';
$LNG['don11']							    = 'Credit';
$LNG['don12']							    = 'Cost';
$LNG['don13']							    = 'Select';
$LNG['don14']							    = 'Buying rate credit (Paysafe Cards)';
$LNG['don15']							    = 'Value';
$LNG['don16']							    = 'Enter in the following form your Paysafe Card Pin Code. Your code will be send to admin (ingame message and mail). Once i will notice a new code, i will see if your given Pin Code is still valid. If it is, i will add u manualy your Dark Matter and your Loyality Points. (Ratio are the same as payal)';
$LNG['don17']							    = 'Send To Admin';
$LNG['don18']							    = 'Buying rate credit (Allopass)';
$LNG['don19']							    = 'It is possible that you receive more darkmatter some houres after your purchase depending on with payment service you used, This only apply to bank transfers payments';
$LNG['don20']							    = 'If you want to have the same ratios as paypal, then consider sending a private message to admin and he will let you know how to proceed';
$LNG['don21']							    = 'Duration of transfer receipt';
$LNG['don22']							    = 'Paypal payment system';
$LNG['don23']							    = 'Phone, Sms, Bank Transfers,...';
$LNG['don24']							    = 'Paysafe Cards';
$LNG['don25']							    = 'Instantly';
$LNG['don26']							    = 'Max 1h';
$LNG['don27']							    = 'Admin have to validate it';
$LNG['don28']							    = 'After payment, Darmatter is automaticaly transfered to your account';
$LNG['don29']							    = 'All transfers are only valid on the above conditions';
$LNG['don30']							    = 'Attention administration of the project is not liable for any conduct of this deal! Administration of the project is not required to return the money you spent under any circumstances! Administration of the project does not guarantee you anything except getting Credit (game currency)! Each player at your own risk spending their money!';
$LNG['don31']							    = 'All transactions are used for the development of the project.<br>Sincerely, Administration';
