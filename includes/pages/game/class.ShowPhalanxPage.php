...
class ShowPhalanxPage extends AbstractPage
{
	...
	static function allowPhalanx($toGalaxy, $toSystem)
	{
		...
		if ($PLANET['galaxy'] != $toGalaxy || $PLANET[$resource[42]] == 0 || !isModulAvalible(MODULE_PHALANX) || $PLANET[$resource[903]] < PHALANX_DEUTERIUM || $PLANET['last_relocate'] > TIMESTAMP - 10 * 60) {
			return false;
		}
