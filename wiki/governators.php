...
<html>
   ...
   Governors - the same officers, hired only for a certain time, usually daily. You can find them by clicking on the left menu - <b> Senate </b> <p>
    ...
    The governator window.
    
    <div align="center"><img style="border-radius:10px"  height="200" src="html/images/13/1.png" onclick="changeSizeImage1(this)"> </div><p> 
    
    Ability of governors: <br />
     <ul>
     <li> Increase armor, attack and defense of your ships- <strong> Veteran </strong>
     <li> power increase shields - <strong> Defense Minister </strong>
    <li>  Reduced time to Construction of buildings - <strong> Design Engineer </strong>
     <li> Increasing raw material extraction - <strong> Miner </strong>
     <li> Increase energy production - <strong> Energetic </strong>
     <li> time reduction studies - <strong> Scientist </strong>
     <li> Increase flight speed ships - <strong> Navigator </strong>
    </ul>
    <p>
    <font size="2"> <b>addition:</b> Governors also hired for DM for 1 day, they can be renewed for an unlimited time. The price ranges from 4.5k and up to 12,000 DM. </font>
