...
<div id="ally_content" class="conteiner">
    <div class="gray_stripe">
        ...
        <a href="game.php?page=alliance" class="batn_lincks right_flank over">Overview alliance</a>                       
    </div>             
    ...
    <div class="gray_stripe">
        ...
        <div class="right_part">	
        	        	<a href="game.php?page=alliance&amp;mode=admin&amp;action=diplomacy" class="batn_lincks diplomacy">{$LNG.al_manage_diplo}</a>
									...
									{* {if $rights.PLANETS} <a href="game.php?page=alliance&amp;mode=admin&amp;action=planets" class="batn_lincks right_flank planets">Planets</a>{/if} *}
        	            <div class="clear"></div>
        </div>
    </div>
...
<input type="hidden" name="send" value="1">
    ...
    <div class="ally_contents">
		...
		{html_options name=stats options=$YesNoSelector selected=$ally_stats_data}
